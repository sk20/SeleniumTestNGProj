...
public class ZipUtils {
	...
	public static void zipReportFolder() {
		if (FrameworkConstants.ZIP_FOLDER.toLowerCase().trim().equals(FrameworkConstants.YES)) {
			if ((FrameworkConstants.ZIP_FOLDER_PATH != null || !FrameworkConstants.ZIP_FOLDER_PATH.isEmpty())
					&& (FrameworkConstants.ZIP_FOLDER_NAME != null || !FrameworkConstants.ZIP_FOLDER_NAME.isEmpty())) {
				ZipUtil.pack(new File(FrameworkConstants.ZIP_FOLDER_PATH),
						new File(FrameworkConstants.ZIP_FOLDER_NAME));
				...
				ZipUtil.pack(new File(FrameworkConstants.EXTENT_REPORT_FOLDER_PATH),
						new File(FrameworkConstants.ZIPPED_EXTENT_REPORTS_FOLDER));
				LogUtils.info("Zipped " + FrameworkConstants.ZIPPED_EXTENT_REPORTS_FOLDER + " successfully !!");
			}
		}
	}

...
public final class Helpers {
	...
	public static String cleanString(final String dirtyString) {
        ...
        String noWhiteSpace = WHITESPACE.matcher(dirtyString).replaceAll("_");
        String normalized = Normalizer.normalize(noWhiteSpace, Normalizer.Form.NFD);
        String cleanString = NONLATIN.matcher(normalized).replaceAll("");
        return cleanString.toLowerCase(Locale.ENGLISH);
    }
